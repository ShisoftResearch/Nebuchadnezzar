...
pub const LSM_TREE_SCHEMA: &'static str = "NEB_LSM_TREE";
pub const LSM_TREE_LEVELS: &'static str = "levels";

lazy_static! {
    pub static ref LSM_TREE_SCHEMA_ID: u32 = key_hash(LSM_TREE_SCHEMA) as u32;
    pub static ref LSM_TREE_LEVELS_HASH: u64 = key_hash(LSM_TREE_LEVELS); 
}
...
impl LSMTree {
    pub async fn create(neb: &Arc<server::NebServer>) -> Self {
...
pub fn lsm_treee_schema() -> Schema {
    Schema {
        id: *LSM_TREE_SCHEMA_ID,
        name: String::from(LSM_TREE_SCHEMA),
        key_field: None,
        str_key_field: None,
        is_dynamic: false,
        fields: Field::new(
